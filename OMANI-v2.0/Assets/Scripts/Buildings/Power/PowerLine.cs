...
public class PowerLine : MonoBehaviour
{
    ...
    public List<PowerLineSection> allRopeSections = new List<PowerLineSection>();
    ...
    void Start()
    {
        ...
        {
            allRopeSections.Add(new PowerLineSection(ropePositions[i]));
        }
    }
    ...
    private void UpdateRopeSimulation(List<PowerLineSection> allRopeSections, float timeStep)
    {
        //Move the last position, which is the top position, to what the rope is attached to
        PowerLineSection lastRopeSection = allRopeSections[allRopeSections.Count - 1];
        ...
        List<PowerLineSection> nextPosVelForwardEuler = new List<PowerLineSection>();
        ...
        {
            PowerLineSection thisRopeSection = PowerLineSection.zero;
        ...
        List<PowerLineSection> nextPosVelHeunsMethod = new List<PowerLineSection>();
    ...
    private List<Vector3> CalculateAccelerations(List<PowerLineSection> allRopeSections)
    {
    ...
    //Implement maximum stretch to avoid numerical instabilities
    private void ImplementMaximumStretch(List<PowerLineSection> allRopeSections)
    {
        ...
        {
            PowerLineSection topSection = allRopeSections[i];

            PowerLineSection bottomSection = allRopeSections[i - 1];
    ...
    {
        PowerLineSection bottomSection = allRopeSections[listPos];
