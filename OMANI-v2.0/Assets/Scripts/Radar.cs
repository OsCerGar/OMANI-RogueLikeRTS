...
public class Radar : MonoBehaviour
{
	...
	public float blipSizePercentage = 20;
	...
	void Start ()
	{
        // (1) caches a reference to the Transform component of the player's character
		...
		// (2) the width and height of the radar image are cached
		...
		// (3) the size each blip should be (width and height) is calculated, using the blipSizePercentage public variable.
